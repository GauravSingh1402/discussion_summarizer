...
const LandingPage = () => {
	...
	return (
		<div className="w-full flex flex-col items-center justify-center">
			<div className="w-full flex flex-col sm:flex-row  justify-evenly pt-20 pb-24">
			...
			>
				...
				<div className="flex items-center justify-evenly">
					<div className="relative w-fit">
						...
						></div>
						<div
							className={`relative rounded-lg flex flex-col w-[400px] h-[350px] bg-white`}
						>
							<Image
								width={400}
								height={400}
					...
					<div className="w-full flex flex-col justify-evenly gap-10 sm:w-[50%] align-center">
						...
						<h3 className="text-sm md:text-lg font-sans text-justify">
			...
			<div
				className={`w-full flex flex-col sm:flex-row  justify-evenly py-10 bg-${theme}-secondary`}
			>
				...
				<div className="w-full flex flex-col py-5 justify-between sm:w-[50%]">
					<h3 className="text-2xl sm:text-3xl font-semibold font-heading text-transparent bg-clip-text bg-gradient-to-r from-custom-gradient-start to-custom-gradient-end">
