  ...
  return (
    ...
    {switchDisplay=='upload' && <label
        ...
        <span className="flex flex-col items-center justify-center space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 text-blue-600" fill="none" viewBox="0 0 24 24"
            ...
            <span className={`font-medium text-gray-500`}>Supports .mr, .flac, .wav, .ogg, .mp3, .mp4, .webm</span>
        </span>
        <input type="file" name="file_upload" className="hidden" onChange={(e)=>{handleFile(e)}}/>
    </label>}
    {switchDisplay!='upload' && switchDisplay!='result' ? <div className='flex flex-col'>
      {
        switchDisplay=='preview' ? (<div className={`bg-gray-500 w-full flex flex-col justify-center p-5 rounded-md`}>
